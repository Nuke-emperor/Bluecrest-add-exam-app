...
if(isset($_POST["sem4_btn_networking"])){
    ...
    if(empty($row_number) || empty($full_name)){
        ...
        $table = "INSERT INTO networking_sem_4 (ROLL_NUMBER,STUDENT_NAME,MODULE_1, MODULE_2,MODULE_3) VALUES ('$row_number','$full_name','$module_1_exam','$module_2_exam','$module_3_exam')";\
