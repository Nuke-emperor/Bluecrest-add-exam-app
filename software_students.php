...
<br>
            ...
            <!-- software sem 2 -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">SOFTWARE SEM 2 <span>| Teacher name</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      $table = "SELECT * FROM `software_sem_2`";
                      $result = mysqli_query($connection, $table) or die(mysqli_error($connection));
                      $checking = mysqli_num_rows($result);
            ...
            <!-- software sem 3 -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">SOFTWARE SEM 3 <span>| Teacher name</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      $table = "SELECT * FROM `software_sem_3`";
                      $result = mysqli_query($connection, $table) or die(mysqli_error($connection));
                      $checking = mysqli_num_rows($result);
            ...
            <!-- software sem 4 -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">SOFTWARE SEM 4 <span>| Teacher name</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      $table = "SELECT * FROM `software_sem_4`";
                      $result = mysqli_query($connection, $table) or die(mysqli_error($connection));
                      $checking = mysqli_num_rows($result);
